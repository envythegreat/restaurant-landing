  ...
  return (
    <section className="c-module-instagram" id="Social">
      ...
      <div className="c-module-instagram__container">
        <div
          id="sb_instagram"
          className="sbi sbi_col_6 sbi_width_resp"
          style={{ paddingBottom: "10px", width: "100%" }}
          data-feedid="sbi_17841402320476986#6"
          data-res="auto"
          data-cols="6"
          data-num="6"
          data-shortcode-atts='{"num":"6","cols":"6","showfollow":"false"}'
          data-sbi-index="1"
        >
          <div
            className="sb_instagram_header  sbi_no_avatar"
          ...
          <div id="sbi_images" style={{ padding: "5px" }}>
            <div
              ...
              id="sbi_17961493619493526"
              data-date="1674810452"
            >
            ...
            <div
              className="sbi_item sbi_type_carousel"
              id="sbi_17945352047525402"
              data-date="1674727057"
            >
              <div className="sbi_photo_wrap">
                <a
                  className="sbi_photo sbi_imgLiquid_bgSize sbi_imgLiquid_ready"
                  ...
                  >
                  <span className="sbi-screenreader">
                    Una de les nostres últimes incorporacions: les po
                  </span>
                  <svg
            ...
            <div
              className="sbi_item sbi_type_carousel"
              id="sbi_17894701046752051"
              data-date="1674640872"
            >
              <div className="sbi_photo_wrap">
                <a
                  className="sbi_photo sbi_imgLiquid_bgSize sbi_imgLiquid_ready"
...
👉 Arròs de calçots, costelló i salsitxes amb romesco 
👉Truita oberta de calçots, carxofes i botifarra de perol"
                  />
                </a>
              </div>
            </div>
            <div
              className="sbi_item sbi_type_image"
              id="sbi_17874922400815934"
              data-date="1674202971"
            >
              <div className="sbi_photo_wrap">
                <a
                  className="sbi_photo sbi_imgLiquid_bgSize sbi_imgLiquid_ready"
            ...
            <div
              className="sbi_item sbi_type_image"
              id="sbi_17923784207550018"
              data-date="1674113813"
            >
              <div className="sbi_photo_wrap">
                <a
                  className="sbi_photo sbi_imgLiquid_bgSize sbi_imgLiquid_ready"
            ...
            <div
              className="sbi_item sbi_type_image"
              id="sbi_18173927620255307"
              data-date="1674030477"
            >
              <div className="sbi_photo_wrap">
                <a
                  className="sbi_photo sbi_imgLiquid_bgSize sbi_imgLiquid_ready"
          ...
          {/* <div id="sbi_load">
            <a className="sbi_load_btn" href="javascript:void(0);">
              <span className="sbi_btn_text">Veure [ + ]...</span>
              <span
                className="sbi_loader sbi_hidden"
